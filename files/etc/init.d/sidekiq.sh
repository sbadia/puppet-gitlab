...
# Default-Stop:      0 1 6
# Short-Description: Sidekiq is a backend helper for GitLab
# Description:       Sidekiq is a backend helper for GitLab
### END INIT INFO
